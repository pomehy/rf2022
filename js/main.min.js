...
/* harmony import */ var _modules_init_header__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-header */ "./js/modules/init-header.js");
...
var initHeader = function initHeader() {
  var pageHeader = new _modules_init_header__WEBPACK_IMPORTED_MODULE_3__["default"]();
  pageHeader.init();
}; // ---------------------------------
...
var baseSendSuccess = function baseSendSuccess(target) {
  window.clearForm(target); // eslint-disable-next-line no-console
...
var formElementValidateAction = function formElementValidateAction(formValidateElement) {
  ...
  if (dataValidateType !== 'toggle-group') {
    ...
    if (dataValidateType === 'phone') {
      ...
      formElement.setAttribute('aria-required', false);
...
var customExampleValidationSuccessCallback = function customExampleValidationSuccessCallback(evt) {
  evt.preventDefault();
  window.clearForm(evt.target); // eslint-disable-next-line no-console
...
var HeaderNav = /*#__PURE__*/function () {
  ...
  _createClass(HeaderNav, [{
    key: "_paintElement",
    value: function _paintElement() {
      var currentScroll = scrollPosition();

      if (currentScroll > this.defaultOffset) {
        this.root.classList.add('is-painted');
      } else {
        this.root.classList.remove('is-painted');
      }
    }
  }, {
    key: "init",
